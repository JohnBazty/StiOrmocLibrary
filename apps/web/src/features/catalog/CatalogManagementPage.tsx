...
export function CatalogManagementPage() {
  ...
  async function submit(event: FormEvent<HTMLFormElement>, kind: 'book' | 'thesis') {
    ...
    try {
      ...
      setNotice({ tone: 'success', text: `${kind === 'book' ? 'Book and physical copy' : 'Research/thesis catalog and inventory record'} created successfully.` })
    } catch (error) {
